...
<head>
    ...
    <script type="text/javascript">
      ...
      function findRemittance(){
        ...
        $.post("${ctx}/dunning/tMisRemittanceMessage/findRemittance",{remittanceSerialNumber:serialNumber,remittanceChannel: "支付宝"},
...
<form id="auditForm">
    ...
    <input type="hidden" name="remittancechannel" value="支付宝">
