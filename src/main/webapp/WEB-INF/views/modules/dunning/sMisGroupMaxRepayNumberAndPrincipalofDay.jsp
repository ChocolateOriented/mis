...
<html>
<head>
    <title>组日还款最大户数&本金</title>
    <meta name="decorator" content="default"/>
    <script type="text/javascript">
        $(document).ready(function() {
            $("#btnExport").click(function(){
                top.$.jBox.confirm("确认要导出组日还款最大户数&本金吗？","系统提示",function(v,h,f){
                    if(v=="ok"){
                        $("#searchForm").attr("action","${ctx}/dunning/tMisDunningMaxRepayNumberAndPrincipalReport/exportGroupMaxRepayNumberAndPrincipal");
                        $("#searchForm").submit();
                    }
                },{buttonsFocus:1});
        ...
        function page(n,s){
            $("#pageNo").val(n);
            $("#pageSize").val(s);
            $("#searchForm").attr("action","${ctx}/dunning/tMisDunningMaxRepayNumberAndPrincipalReport/groupMaxRepayNumberAndPrincipalofDay");
            $("#searchForm").submit();
            return false;
        }
    </script>
...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/dunning/tMisDunningMaxRepayNumberAndPrincipalReport/groupMaxRepayNumberAndPrincipalofDay">组日还款最大户数&本金</a></li>
</ul>
<form:form id="searchForm"  action="${ctx}/dunning/groupMaxRepayNumberAndPrincipalofDay/" method="post" class="breadcrumb form-search">
