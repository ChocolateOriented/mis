...
// 				$.get("${ctx}/oa/oaNotify/self/count?updateSession=0&t="+new Date().getTime(),function(data){
// 					var num = parseFloat(data);
// // 					$("#notifyNum,#notifyNum3").show().html("("+5+")");
// 					if (num > 0){
// 						$("#notifyNum,#notifyNum3").show().html("("+num+")");
// 					}else{
// 						$("#notifyNum,#notifyNum3").hide()
// 					}
// 				});
// 			}
...
<%-- 				<a href="${pageContext.request.contextPath}${fns:getFrontPath()}/index-${fnc:getCurrentSiteId()}.html" target="_blank" title="访问网站主页"> --%>
					...
					<div style='height:50px;width:50px;overflow:hidden;text-align:center; display: table-cell; vertical-align:middle;'>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; ${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="https://www.mo9.com" target="_blank">mo9</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
