...
public class TMisRemittanceExcel extends DataEntity<TMisRemittanceExcel> {
	...
	@DecimalMin(value = "0",message = "收入必须大于0")
	...
	public String toString() {
		return "TMisRemittanceExcel [dbid=" + dbid + ", remittancetime=" + remittancetime
				+ ", alipayRemittanceNumber="
				+ alipayRemittanceNumber + ", alipaySerialNumber=" + alipaySerialNumber
				+ ", commercialOrderNumber="
				+ commercialOrderNumber + ", serveType=" + serveType + ", remittanceamount="
				+ remittanceamount
				+ ", outPay=" + outPay + ", payBalance=" + payBalance + ", serverPay=" + serverPay
				+ ", remittancechannel=" + remittancechannel + ", conProduct=" + conProduct
				+ ", remittanceaccount="
