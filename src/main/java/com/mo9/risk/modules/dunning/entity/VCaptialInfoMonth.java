 ...
 * @version 2016-09-25
 */
public class VCaptialInfoMonth extends DataEntity<VCaptialInfoMonth> {
	...
	private Double smsPercent;		// sms_percen短信费占比
	
	public VCaptialInfoMonth() {
		super();
	}

	public VCaptialInfoMonth(String id){
		super(id);
	}

	@Length(min=1, max=6, message="month长度必须介于 1 和 6 之间")
