...
public class RiskOrderManager {
	...
	private static final List<String> SERVER_BUSY_CODES = Arrays.asList("-10","-11","-12");//系统繁忙响应码
	 ...
	 */
	public String repay (String dealcode, String paychannel, String paytype, BigDecimal payamount, String thirdCode)
