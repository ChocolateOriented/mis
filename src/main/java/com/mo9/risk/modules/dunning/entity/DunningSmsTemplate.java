...
public enum DunningSmsTemplate {
    ...
    public String getContent(String... args)
    {
        ...
        {
        	case ST_0:
        		source =  "{0}江湖救急用户，您的借款已到还款期，应还金额{1}元。为避免影响您的个人信用，请收到短信后立刻前往江湖救急页面完成还款。详询: 02180163503";
        		break;
            case ST__1_7:
                source =  "{0}江湖救急用户，您的借款已过还款期，应还金额{1}元。为避免影响您的个人信用，请收到短信后立刻前往江湖救急页面完成还款。详询: 02180163503";
                break;
            case ST_8_14:
                source = "{0}江湖救急用户，您的借款已过还款期，应还金额{1}元。请于2天之内完成还款或申请续期。否则我司将按《征信业管理条例》如实上报金融信用信息基础数据库，" +
                        "如对个人征信造成影响请自行负责。详询: 02180163503";
                break;
            case ST_15_21:
                source = "{0}您好: {1}，身份证尾号{2}。您申请的江湖救急借款已经拖欠{3}天，逾期金额{4}元，相关法律函件近期将邮寄至您的户籍地址，请注意查收。" +
                        "详询请回电02180163503。请确保按函件要求还款，否则我们将考虑详您户籍地村委会/居委会以及工作单位通报情况，协助调查。";
                break;
            case ST_22_35:
                source = "{0}您好: {1},身份证尾号{2}。您长期拖欠江湖救急借款，欠款金额达{3}元。已经涉嫌触犯《刑法》224条和193条，" +
                        "以非法占有为目的骗取对方财物，涉嫌合同诈骗罪和借款诈骗罪。相关法律函件近期将邮寄至您户籍所在地。请注意查收。" +
                        "请确保按函件要求还款，否则我司将向公安机关报案，依法追究您的法律责任。详询02180163503";
                break;
            case ST_15_PLUS:
                source = "{0}您好，您的亲属/朋友：{1}, 向江湖救急的借款已经严重逾期，截至今日逾期{2}天，欠款金额{3}元。" +
