...
public enum DunningSmsTemplate {
    ...
    public String getContent(String... args)
    {
        ...
        {
        	case ST_0:
        		source =  "【mo9】江湖救急用户，您的借款已到还款期，应还金额{0}元。为避免影响您的个人信用，请收到短信后立刻前往江湖救急页面完成还款。详询: 02180163503";
        		break;
            case ST__1_7:
                source =  "【mo9】江湖救急用户，您的借款已过还款期，应还金额{0}元。为避免影响您的个人信用，请收到短信后立刻前往江湖救急页面完成还款。详询: 02180163503";
                break;
            case ST_8_14:
