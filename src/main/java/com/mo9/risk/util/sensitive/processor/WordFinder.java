...
import com.mo9.risk.util.sensitive.util.AnalysisUtil;
...
public class WordFinder implements Processor {
     ...
     */
    @Override
    public List<SensitiveWordResult> process(Map<String, Map> wordsTree, String text, AbstractFragment fragment, int minLen) {
        // 词的前面一个字
        String pre = null;
        // 词匹配的开始位置
        int startPosition = 0;
