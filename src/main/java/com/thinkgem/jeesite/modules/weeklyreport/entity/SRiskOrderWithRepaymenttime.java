 ...
 * @version 2016-11-30
 */
public class SRiskOrderWithRepaymenttime extends DataEntity<SRiskOrderWithRepaymenttime> {
	...
	public SRiskOrderWithRepaymenttime() {
		super();
	}

	public SRiskOrderWithRepaymenttime(String id){
		super(id);
	}
