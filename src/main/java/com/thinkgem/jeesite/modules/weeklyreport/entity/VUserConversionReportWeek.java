 ...
 * @version 2016-07-20
 */
public class VUserConversionReportWeek extends DataEntity<VUserConversionReportWeek> {
...
//	private BigDecimal waitingtimeavg02;		// 5-7 首单平均等待时间
	...
	public VUserConversionReportWeek() {
		super();
	}

	public VUserConversionReportWeek(String id){
		super(id);
	}

	@Length(min=1, max=60, message="周的描述显示长度必须介于 1 和 50 之间")
