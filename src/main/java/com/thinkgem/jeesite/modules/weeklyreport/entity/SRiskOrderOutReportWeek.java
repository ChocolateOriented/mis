 ...
 * @version 2016-12-09
 */
public class SRiskOrderOutReportWeek extends DataEntity<SRiskOrderOutReportWeek> {
	
	private static final long serialVersionUID = 1L;
	private String createtime;		// 周
	...
	public SRiskOrderOutReportWeek() {
		super();
	}

	public SRiskOrderOutReportWeek(String id){
		super(id);
	}
