...
//        return new EqualsBuilder().append(this.id, entity.getId()).isEquals();
//    }
...
//    {
//        Date now = new Date();
//        //默认id生成规则：24位纯数字格式, yyyyMMddHHmmssSSS+7位随机数字
//        return  DATE_FORMAT.format(now) + String.format("%07d", Math.round(Math.random() * 10000000));
//    }
